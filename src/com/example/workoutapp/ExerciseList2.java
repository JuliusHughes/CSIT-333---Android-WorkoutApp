...
public class ExerciseList2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.exercise_list2);
		db2 = openOrCreateDatabase("Fitness2DB",MODE_PRIVATE, null);
		db2.execSQL("CREATE TABLE IF NOT EXISTS Workout2(exercise VARCHAR,weight INTEGER,sets INTEGER, reps INTEGER);");
	}
	...
	public void addButton(View view)
	{
		...
		db2.execSQL("INSERT INTO  Workout2 VALUES('"+exercise+"','"+weight+"','"+sets+"', '"+reps+"');");
		
		
		Toast.makeText(ExerciseList2.this, "Exercise added", Toast.LENGTH_LONG).show();
	}
	
	public void showData(View view)
	{
	    Cursor c = db2.rawQuery("SELECT * from Workout2", null);
