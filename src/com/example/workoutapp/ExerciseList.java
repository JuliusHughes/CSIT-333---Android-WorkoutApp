...
public class ExerciseList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS Workout(exercise VARCHAR,weight INTEGER,sets INTEGER, reps INTEGER);");
	}

	public void addButton(View view)
	{
		Spinner exerciseTxt = (Spinner) findViewById(R.id.spinExercise);
		EditText weightTxt = (EditText) findViewById(R.id.editWeight);
		EditText repsTxt = (EditText) findViewById(R.id.editReps);
		EditText setsTxt = (EditText) findViewById(R.id.editSets);
		...
		db.execSQL("INSERT INTO  Workout VALUES('"+exercise+"','"+weight+"','"+sets+"', '"+reps+"');");
		
		
		Toast.makeText(ExerciseList.this, "Exercise added", Toast.LENGTH_LONG).show();
	}
